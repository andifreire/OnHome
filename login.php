...
<?php
	...
	if(count($_POST) > 0) {
		...
		if(mysqli_num_rows($res) == 0) {
			echo "no se pudo iniciar sesion, ususario no encontrado";
		}
...
<head>
  ...
  <title>Inicio de sesion- On Home</title>
...
<body>
  ...
  <header class="site-header">
    <nav>
      <div class="max"> <a class="logo" href="/">
          ...
          </svg>The Brown Owl</a><a href="Users/user/Desktop/about.html">About</a><a href="Users/user/Desktop/contact.html">Contact</a></div>
    </nav>
    <div>
    </div>
  </header>
 ...
 -->
    <div class="max"> 
	 ...
	 <a href="form_registro.php">Registrate</a> <p>en el sitio</p>
      <div class="grid">
        <div>
          <h2>Visit Us</h2>
          <dl>
            <dt>123 Main Street</dt>
            <dt>Seattle, Washington</dt>
          </dl>
        </div>
        <div>
          <h2>Reservations</h2>
